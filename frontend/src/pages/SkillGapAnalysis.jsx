...
export default function SkillGapAnalysis() {
  ...
  const [overallMatch, setOverallMatch] = useState('68%');
  const [loading, setLoading] = useState(true);

  useEffect(() => {
    async function fetchAnalysis() {
      try {
        const response = await authFetch('/analysis', {
          headers: {
        ...
        if (response.ok) {
          ...
          if (data.overallMatch) {
            setOverallMatch(data.overallMatch);
          }
        }
      } catch (err) {
        console.error('[SkillGapAnalysis] Using fallback cache for database calculation:', err);
      } finally {
        setLoading(false);
      }
    }
        ...
        <div style={styles.headerContent}>
          <div>
            ...
            <p style={styles.headerSubtitle}>
              Live dynamic gap computation comparing student profile against target position requirements in database
            </p>
          </div>
          ...
          <table style={styles.table}>
            <thead>
              <tr style={styles.trHead}>
                ...
                <th style={{ ...styles.th, textAlign: 'center' }}>Current Score (1–5)</th>
                <th style={{ ...styles.th, textAlign: 'center' }}>Required Score (1–5)</th>
